...
const questions = [
  ...
  {
    id: 2,
    name: <b style={{ color: 'gray', fontWeight: 'bold' }}>Limited Version</b>,
              ...
              {step === 1 ? (
                ...
                >
                  ...
                  <div className="flex gap-[15px] justify-end mt-8">
                    ...
                    <button
    onClick={() => {
      router.push('https://martin-adv-02.vercel.app'); // Using the router to navigate to the URL
    }}
            ...
            >
              ...
              >
                <ul className="mb-auto list-none">
                  ...
                  <p className="text-[12px] font-extrabold text-[#FFB6C1]">
  MARTIN
                  ...
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    ...
                    <p className="ml-[3px] mr-[6px]">Conversation History</p>
                  ...
                  <li className="list-none flex items-center rounded-[3px] relative bg-white text-gray-600 w-full m-0 cursor-pointer hover:bg-[#F7F7F8] focus:outline-none py-[4px]">
                    ...
                    <div style={{ paddingRight: '16px', paddingLeft: '18px', overflow: 'hidden' }}>
                    <div style={{ color: 'black', fontWeight: 'bold' }}>Headache</div>
                    <div style={{ color: 'gray', fontWeight: 'regular' }}>Apr 12, 2024</div>
                  ...
                  <li className="list-none flex items-center rounded-[3px] relative bg-white text-gray-600 w-full m-0 cursor-pointer hover:bg-[#F7F7F8] focus:outline-none py-[4px]">
                    ...
                    <div style={{ paddingRight: '16px', paddingLeft: '18px', overflow: 'hidden' }}>
                    <div style={{ color: 'black', fontWeight: 'bold' }}>Regular healthcheck</div>
                    <div style={{ color: 'gray', fontWeight: 'regular' }}>Apr 07, 2024</div>
                  ...
                  <li className="list-none flex items-center rounded-[3px] relative bg-gray-100 text-gray-600 w-full m-0 cursor-pointer hover:bg-[#F7F7F8] focus:outline-none py-[4px]">
                    ...
                    <div style={{ paddingRight: '16px', paddingLeft: '18px', overflow: 'hidden' }}>
                    <div style={{ color: 'black', fontWeight: 'bold' }}>COVID-19 symptoms Check</div>
                    <div style={{ color: 'gray', fontWeight: 'regular' }}>March 30, 2024</div>
                  ...
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    ...
                    <p className="ml-[3px] mr-[6px]">Medical Records</p>
                  </li>
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    <svg
                      className="h-4 w-4 text-gray-700"
                    ...
                    <p className="ml-[3px] mr-[6px]">TeleMedicine</p>
                  </li>
                  <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-900 py-[4px]">
                    <svg
                      className="h-4 w-4 text-gray-700"
              ...
              <div className="bg-white text-[#667380] p-[18px] flex flex-col">
                {step === 1 ? (
                  ...
                  <div>
                    ...
                    <ul className="mt-[28px] flex">
                      <li className="list-none max-w-[400px]">
                        Start off by explaining what the function does, and its time and space complexities. Then go into how you would optimize it.
                      </li>
                    </ul>
                  </div>
                )}
                        ...
                        <div className="group relative w-full">
                          <div className="relative mb-2 flex h-full max-h-[200px] w-full cursor-pointer items-start justify-between rounded-lg p-2 font-medium transition duration-100">
                            ...
                            <div className="relative flex h-full flex-col overflow-hidden">
                              ...
                              inquired about the causes and treatment options for headaches. They received detailed explanations on various triggers, prevention strategies, and effective remedies to manage their condition.
                              </p>
                      ...
                      <li className="list-none relative flex items-stretch text-left">
                        <div className="group relative w-full">
                          <div className="relative mb-2 flex h-full max-h-[200px] w-full cursor-pointer items-start justify-between rounded-lg p-2 font-medium transition duration-100">
                            ...
                            <div className="relative flex h-full flex-col overflow-hidden">
                              <div className="flex items-center text-left text-[#1a2b3b]">
                                <p>COVID-19 symptoms check</p>
                              </div>
                              <p className="text-wrap grow font-normal text-[7px]">
                              conducted a COVID-19 symptoms check, seeking clarity on the indicators of the virus. They were provided with a comprehensive list of symptoms, including fever, cough, and difficulty breathing, and advised on the next steps for testing and self-isolation.
                              </p>
                              <div className="flex flex-row space-x-1">
                                <p className="inline-flex items-center justify-center truncate rounded-full border-[0.5px] border-gray-300 px-[3px] text-[7px] font-normal hover:bg-gray-50">
                                  March 30, 2024
